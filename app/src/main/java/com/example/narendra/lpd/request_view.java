...
public class request_view extends Fragment {
    ...
    request_adpater request_adpater;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView= (RecyclerView)v.findViewById(R.id.recview_request);
        getrequest objreq=new getrequest();
        objreq.execute();
        return v;
    }
    ...
    public class getrequest extends AsyncTask<Void,String,JSONObject>{
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                wb.webservices("get_request",jsobj);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return wb.jsonres;
        ...
        try {
            ...
            for (int i=x-1;i>=0;i--){
                ...
                request_datas.add(new request_data(getContext(),outjobj2.getDouble("srclat"),outjobj2.getDouble("srclong"),outjobj2.getDouble("deslat"),
                        ...
                        BigDecimal.valueOf(outjobj1.getDouble("cost")).floatValue(),outjobj1.getInt("packid"),
                        outjobj1.getInt("reqid"),outjobj2.getString("reccon"),outjobj1.getString("time"),outjobj3.getString("main_cat"),outjobj3.getString("sub_cat"),(float)-1));
            }

            recyclerView.setHasFixedSize(true);
            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

            request_adpater=new request_adpater(getActivity(),request_datas);
            recyclerView.setAdapter(request_adpater);
