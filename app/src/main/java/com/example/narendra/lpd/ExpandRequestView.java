...
/**
 * Created by Narendra on 15-03-2018.
 */

public class ExpandRequestView extends RecyclerView.Adapter<ExpandRequestView.requestViewHolder> {
    Context context;
    ...
    public ExpandRequestView (Context context, List<request_data> request_datas) {
        this.context = context;
        this.request_datas = request_datas;
    }

    @Override
    public ExpandRequestView.requestViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view=inflater.inflate(R.layout.lay_exapandrequestview,null,false);
        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT,RecyclerView.LayoutParams.WRAP_CONTENT));
        return new ExpandRequestView.requestViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ExpandRequestView.requestViewHolder holder, final int position) {
            ...
            public void onClick(final View v) {
                ...
                intru.setMessage("You Want to Accept ?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mn.beginTransaction().replace(R.id.include2,fm,"frag_Route").addToBackStack(null).commit();
                    }
