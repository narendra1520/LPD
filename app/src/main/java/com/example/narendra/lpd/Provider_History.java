 ...
 */
public class Provider_History extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_provider_history, container, false);
        recyclerView= (RecyclerView)v.findViewById(R.id.history_rec);
        Provider_History.gethistory objreq= new gethistory();
        objreq.execute();
        return v;
    }
    ...
    public class gethistory extends AsyncTask<Void,String,JSONObject> {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                wb.webservices("get_pro_history",jsobj);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return wb.jsonres;
        ...
        try {
            ...
            for (int i=x-1;i>=0;i--){
                ...
                request_datas.add(new request_data(getContext(),outjobj2.getDouble("srclat"),outjobj2.getDouble("srclong"),outjobj2.getDouble("deslat"),
                        ...
                        outjobj1.getInt("reqid"),outjobj2.getString("reccon"),outjobj1.getString("time"),outjobj3.getString("main_cat"),outjobj3.getString("sub_cat"),
